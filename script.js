function showFunFact() {
  ...
  const facts = [
    ...
    "Fun Fact: My work spans multiple countries across the ASKAN region, aligning digital initiatives with business priorities. I also combine technical foundations with customer experience strategy to drive measurable digital impact."
  ];
